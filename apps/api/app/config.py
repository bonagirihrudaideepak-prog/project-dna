...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://projectdna:projectdna@localhost:5432/projectdna"
    ...
    analysis_max_commits: int = 2000
    analysis_max_bytes: int = 209715200
    analysis_max_file_bytes: int = 524288
