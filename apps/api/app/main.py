...
from .api import archaeology as archaeology_api
from .api import auth as auth_api
from .api import dna as dna_api
from .api import projects as projects_api
from .config import settings
from .db import SessionLocal, engine, init_db
from .logging_utils import log_with_context, new_request_id, setup_logging
from .models.base import Base
from .schemas import ErrorOut

logger = logging.getLogger("projectdna.api")

app = FastAPI(title="Project DNA", version="0.1.0", docs_url="/api/docs", openapi_url="/api/openapi.json")
...
def readiness():
    """True readiness: verifies the DB is reachable."""
    try:
